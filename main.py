...
firebase_admin.initialize_app(cred,{
    ...
    'storageBucket':'attendance-using-face-recog.appspot.com'
})
...
imgStudent =  cv2.imread('Images/2215.png,2220.png,2541.png,2654.png')
        ...
        if counter != 0:
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    height, width, channels = imgStudent.shape
